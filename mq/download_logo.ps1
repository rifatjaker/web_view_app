# PowerShell script to download MQ logo and set up as app icon

$logoUrl = "https://mqschoolofmathematics.com/mq.png"
$outputDir = "app\src\main\res\drawable"
$logoFile = "$outputDir\mq_logo.png"

Write-Host "Downloading MQ logo from $logoUrl..." -ForegroundColor Green
